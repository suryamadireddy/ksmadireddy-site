...
import { mediaShellBase } from "@/app/components/contentLayout";
...
export default function AtlasProjectPage() {
  return (
    <ProjectShell maxWidth="7xl" title="ATLAS" headerSpacing="compact">
      ...
      <CaseStudySection label="Preview">
        <div
          className={`${mediaShellBase} relative w-full overflow-hidden aspect-[16/10]`}
        >
          <img
